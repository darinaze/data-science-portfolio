...
<!-- Встав реальні назви своїх демо-скріншотів із цієї папки і прибери <!-- --> -->

**Duplicate pair — correctly detected:**
<!-- <p align="center"><img src="./demo_duplicate.png" width="760" alt="Duplicate detected"></p> -->

**Different questions — correctly NOT flagged:**
<!-- <p align="center"><img src="./demo_not_duplicate.png" width="760" alt="Not a duplicate"></p> -->

> Ці демо-скріншоти вже є в кейсі — просто впиши їхні реальні назви у рядки вище.
