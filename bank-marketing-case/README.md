...
<p align="center"><img src="./cover2_Conversion_Prediction_v2.png" width="760" alt="Customer Conversion Prediction cover"></p>
...
<p align="center"><img src="./case_problem_before.png" width="760" alt="Before — calling everyone wastes time and money"></p>
...
<p align="center"><img src="./case_solution_after.png" width="760" alt="After — the model picks who to call, most say yes"></p>
...
**What drives a client's decision (SHAP):** the model shows *why* each client gets their score.

<p align="center"><img src="./shap.png" width="760" alt="SHAP — what drives a client's decision"></p>

**Why LightGBM won (model comparison):** I tested four algorithms and kept the best.

<p align="center"><img src="./models_comparison.png" width="760" alt="Model comparison — LightGBM wins"></p>
